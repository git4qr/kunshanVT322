...
src/OSA_CAP/src/%.o: ../src/OSA_CAP/src/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I../include -I../src/plantCtrl -I../src/port -I../src/ptz -I../src/OSA_CAP/inc -O3 -std=c++11 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_53,code=sm_53 -m64 -odir "src/OSA_CAP/src" -M -o "$(@:%.o=%.d)" "$<"
